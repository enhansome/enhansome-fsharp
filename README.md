...
* [F# main repository](https://github.com/dotnet/fsharp) ⭐ 4,330 | 🐛 1,270 | 🌐 F# | 📅 2026-09-10
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [ASP.NET Core Blazor](https://github.com/dotnet/aspnetcore/tree/main/src/Components) ⭐ 38,431 \| 🐛 4,156 \| 🌐 C# \| 📅 2026-09-10                                                                                                                                 | [Bolero](https://github.com/fsbolero/Bolero) ⭐ 1,133 \| 🐛 69 \| 🌐 F# \| 📅 2026-09-06                                                                                                                                                                                                                 |
| [ASP.NET Core](https://github.com/dotnet/aspnetcore) ⭐ 38,431 \| 🐛 4,156 \| 🌐 C# \| 📅 2026-09-10                                                                                                                                                                 | [Giraffe](https://github.com/giraffe-fsharp/Giraffe) ⭐ 2,254 \| 🐛 45 \| 🌐 F# \| 📅 2026-09-08 (+ optionally [Saturn](https://github.com/SaturnFramework/Saturn) ⭐ 725 \| 🐛 55 \| 🌐 F# \| 📅 2024-07-31)<br/>[Oxpecker](https://github.com/Lanayx/Oxpecker) ⭐ 424 \| 🐛 10 \| 🌐 F# \| 📅 2026-09-08 |
| [Avalonia](https://github.com/AvaloniaUI/Avalonia) ⭐ 31,463 \| 🐛 1,873 \| 🌐 C# \| 📅 2026-09-09                                                                                                                                                                   | [Avalonia.FuncUI](https://github.com/fsprojects/Avalonia.FuncUI) ⭐ 1,257 \| 🐛 16 \| 🌐 F# \| 📅 2026-08-23                                                                                                                                                                                             |
| [MAUI](https://github.com/dotnet/maui) ⭐ 23,321 \| 🐛 3,910 \| 🌐 C# \| 📅 2026-09-10/[Xamarin.Forms](https://github.com/xamarin/Xamarin.Forms) ⚠️ Archived                                                                                                         | [Fabulous](https://github.com/fabulous-dev/Fabulous) ⭐ 1,271 \| 🐛 13 \| 🌐 F# \| 📅 2026-09-09                                                                                                                                                                                                         |
| [MSTest](https://github.com/microsoft/testfx) ⭐ 1,044 \| 🐛 62 \| 🌐 C# \| 📅 2026-09-09/[NUnit](https://github.com/nunit/nunit) ⭐ 2,623 \| 🐛 261 \| 🌐 C# \| 📅 2026-09-09/[xUnit.net](https://github.com/xunit/xunit) ⭐ 4,603 \| 🐛 20 \| 🌐 C# \| 📅 2026-09-10 | [FsUnit](https://github.com/fsprojects/FsUnit) ⭐ 445 \| 🐛 6 \| 🌐 F# \| 📅 2025-07-11                                                                                                                                                                                                                  |
| [System.Text.Json](https://github.com/dotnet/runtime/tree/main/src/libraries/System.Text.Json) ⭐ 18,260 \| 🐛 7,777 \| 🌐 C# \| 📅 2026-09-10                                                                                                                       | [FSharp.SystemTextJson](https://github.com/Tarmil/FSharp.SystemTextJson) ⭐ 367 \| 🐛 45 \| 🌐 F# \| 📅 2026-06-02                                                                                                                                                                                       |
| [WPF](https://github.com/dotnet/wpf) ⭐ 7,725 \| 🐛 1,672 \| 🌐 C# \| 📅 2026-09-09                                                                                                                                                                                  | [Elmish.WPF](https://github.com/elmish/Elmish.WPF) ⭐ 462 \| 🐛 61 \| 🌐 F# \| 📅 2024-10-01                                                                                                                                                                                                             |

<!--lint enable double-link -->

## Actor Frameworks

* [Orleans](https://github.com/dotnet/orleans) ⭐ 10,860 | 🐛 646 | 🌐 C# | 📅 2026-09-10 - Distributed virtual actor model.
* [Akka.NET](https://github.com/akkadotnet/akka.net) ⭐ 5,082 | 🐛 473 | 🌐 C# | 📅 2026-09-09 - Community-driven port of the popular Java/Scala framework Akka to .NET.
...
* [Ionide FSharp.Analyzers.SDK](https://github.com/ionide/FSharp.Analyzers.SDK) ⭐ 85 | 🐛 39 | 🌐 F# | 📅 2026-09-07 - Library for building custom analyzers for F# / FSharp.Analyzers.Cli.
...
* [Fable](https://github.com/fable-compiler/Fable) ⭐ 3,151 | 🐛 161 | 🌐 F# | 📅 2026-09-09 - F# to JavaScript compiler.
...
* [FSharp.Control.AsyncSeq](https://github.com/fsprojects/FSharp.Control.AsyncSeq) ⭐ 175 | 🐛 8 | 🌐 F# | 📅 2026-09-08 - Asynchronous sequence support, integration with `IAsyncEnumerable`.
...
* [FIO](https://github.com/iyyel/fio) ⭐ 96 | 🐛 5 | 🌐 F# | 📅 2026-09-09 - A type-safe, highly concurrent and asynchronous library for F# based on pure functional programming.
...
* [Deedle](https://github.com/BlueMountainCapital/Deedle) ⭐ 1,006 | 🐛 7 | 🌐 F# | 📅 2026-09-10 - Exploratory data library for .NET.
...
* [Fantomas](https://github.com/fsprojects/fantomas) ⭐ 833 | 🐛 79 | 🌐 F# | 📅 2026-09-08 - F# code formatter.
...
* [FsToolkit.ErrorHandling](https://github.com/demystifyfp/FsToolkit.ErrorHandling) ⭐ 552 | 🐛 13 | 🌐 F# | 📅 2026-09-04 - Clear, simple and powerful error handling with railway-oriented programming. Inspired by Chessie.
...
* [Npgsql.FSharp](https://github.com/Zaid-Ajaj/Npgsql.FSharp) ⭐ 339 | 🐛 16 | 🌐 F# | 📅 2026-02-28 - Thin F# wrapper around [Npgsql](https://github.com/npgsql/npgsql) ⭐ 3,725 | 🐛 225 | 🌐 C# | 📅 2026-09-08, the PostgreSQL database driver.
...
* [SqlHydra](https://github.com/JordanMarr/SqlHydra) ⭐ 262 | 🐛 8 | 🌐 F# | 📅 2026-09-08 - Suite of NuGet packages for working with databases in F# including query expressions and code generation tools (for generating strongly typed F# DTO record types based on your database tables). Supports MySQL, PostgreSQL, Oracle, SQL Server, and SQLite.
...
* [Nu Game Engine](https://github.com/bryanedds/Nu) ⭐ 1,363 | 🐛 200 | 🌐 F# | 📅 2026-09-09 - Cross-platform F# 2D game engine built in the functional style. Uses SDL2 and Farseer Physics.
...
* [Fabulous](https://github.com/fabulous-dev/Fabulous) ⭐ 1,271 | 🐛 13 | 🌐 F# | 📅 2026-09-09 - F# functional app development, using declarative dynamic UI.
...
* [Paket](https://github.com/fsprojects/Paket) ⭐ 2,085 | 🐛 708 | 🌐 F# | 📅 2026-09-09 - Dependency manager for .NET with support for NuGet packages and Git repositories.

## Parsing

* [FParsec](https://github.com/stephan-tolksdorf/fparsec) ⭐ 560 | 🐛 31 | 🌐 F# | 📅 2023-11-13 - The parser combinator library for F#.
...
* [SkunkHTML](https://github.com/mg0x7BE/skunk-html) ⭐ 166 | 🐛 2 | 🌐 F# | 📅 2026-09-09 - Markdown blog with GitHub Pages.

## Testing

<!--lint disable double-link -->

* [NBomber](https://github.com/PragmaticFlow/NBomber) ⭐ 2,237 | 🐛 176 | 🌐 CSS | 📅 2026-08-17 - Simple load testing framework for Pull and Push scenarios.
...
* [altcover](https://github.com/SteveGilham/altcover) ⭐ 532 | 🐛 4 | 🌐 F# | 📅 2026-09-09 - Cross-platform coverage gathering and processing tool set for .NET/.NET core and Mono.
...
* [SwaggerProvider](https://github.com/fsprojects/SwaggerProvider) ⭐ 278 | 🐛 5 | 🌐 F# | 📅 2026-09-09 - Generative type provider for Swagger.
...
* [Facil](https://github.com/cmeeren/Facil) ⭐ 152 | 🐛 4 | 🌐 F# | 📅 2026-09-08 - Generates F# data access source code from SQL queries and stored procedures.
...
* [Giraffe](https://github.com/giraffe-fsharp/Giraffe) ⭐ 2,254 | 🐛 45 | 🌐 F# | 📅 2026-09-08 - Native functional ASP.NET Core web framework for F# developers.
* [Suave](https://github.com/SuaveIO/suave) ⭐ 1,348 | 🐛 8 | 🌐 F# | 📅 2026-09-09 - A simple web development F# library providing a lightweight web server and a set of combinators to manipulate route flow and task composition.
...
* [Feliz](https://github.com/Zaid-Ajaj/Feliz) ⭐ 613 | 🐛 1 | 🌐 F# | 📅 2026-07-09 - A fresh retake of the React API in Fable and a collection of high-quality components to build React applications in F#.
* [Oxpecker](https://github.com/Lanayx/Oxpecker) ⭐ 424 | 🐛 10 | 🌐 F# | 📅 2026-09-08 - ASP.NET Core based F# framework + supporting tools (ViewEngine, Htmx, OpenApi).
...
* [Awesome .NET!](https://github.com/quozd/awesome-dotnet) ⭐ 21,591 | 🐛 150 | 📅 2026-03-26 - Collection of awesome .NET libraries, tools, frameworks and software.
